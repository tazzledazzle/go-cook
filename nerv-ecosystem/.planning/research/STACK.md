...
**Domain:** Go-based multi-language (Go/Java/Python) developer-platform CLI — project generator + semver-gated publish + OCI dependency graph + observability scaffolding (Modular/Nerv-style paved road)
**Researched:** 2026-07-24
**Confidence:** HIGH (core Go tooling — verified against pkg.go.dev/GitHub release metadata, July 2026) / MEDIUM (architecture judgment calls on how components compose, since no single reference project does exactly this combination)
...
go get golang.org/x/exp/apidiff  # apidiff library (no fixed version; use golang.org/x/exp/cmd/apidiff for the CLI binary)
...
go get github.com/prometheus/client_golang@v1.24.0
...
# Dev dependencies
go get -d github.com/stretchr/testify@v1.11.1
go get -d github.com/testcontainers/testcontainers-go@v0.43.0
go install github.com/golangci/golangci-lint/v2/cmd/golangci-lint@v2.12.2
go install github.com/spf13/cobra-cli@latest   # scaffolds the CLI's own command boilerplate
go install golang.org/x/exp/cmd/apidiff@latest
```

```bash
# Local infra (docker-compose services, not go.mod deps)
docker pull ghcr.io/project-zot/zot-linux-amd64:latest   # local OCI registry
docker pull otel/opentelemetry-collector-contrib:latest  # OTLP -> Prometheus bridge
...
**If the semver gate targets a Go package:**
...
**If the semver gate targets a Java or Python package:**
...
**If you want the demo to also prove out a "real" Kubernetes deploy (stretch goal, not MVP):**
...
**If the local template store needs to grow beyond `embed.FS` (e.g., users want to add templates without recompiling the binary):**
...
---
*Stack research for: Go-based multi-language project-generator/paved-road CLI (Modular/Nerv-style)*
*Researched: 2026-07-24*
